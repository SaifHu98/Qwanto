...
2026-08-21 | Antigravity | Added cross-platform C test builder/runner (build_and_run_c_tests.py) for Windows CI, guarded negative file descriptors in compat.h against CRT invalid parameter crashes, and verified all 17 native C test binaries and full suite. | c/compat.h; c/tools/build_and_run_c_tests.py; .github/workflows/ci.yml; AGENT_LOG.md | All 17 C test binaries passed; Python 253 passed/4 skipped; Web 57 passed; all audits clean. | Windows/Linux native C CI test execution 100% green.
