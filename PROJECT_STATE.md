...
- **Tools**: `qwn_convert.py`, `qwn_ppl.py`, `qwn_benchmark_v2.py` (real harness), `bench_turboquant.py`, `qwn_benchmark_thinking.py`, `qwn_thinking.py`, `qwn_benchmark_speculative.py`, `qwn_speculative.py`, `qwn_plan_cli.py` (emit `quant_plan.json`), `quant_ablation.py`, `convert_olmoe.py`, `convert_fp8_to_int4.py`, `make_glm_*`.
...
- **Tests**: `c/tests/` (pytest, 164 passed + 12 skipped; Saguaro Speculative suite 430/430 passed; Thinking Engine suite 162/162 passed; TurboQuant verification suite 600/600 passed; HyperVSQ-2 C kernel suite 140/140 passed), `c/iobench.c`, `c/Makefile` for native tests.
