  ...
  return (
    <div className="browser-console-shell" data-testid="browser-chat-shell">
      <header className="browser-console-header">
        <div className="browser-brand"><img className="brand-icon" src="/qwanto-icon.png" alt="Qwanto Native" /><div><strong>Qwanto Web</strong><span>Local chat console</span></div></div>
