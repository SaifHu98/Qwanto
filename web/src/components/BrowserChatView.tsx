  ...
  return (
    <div className="browser-console-shell" data-testid="browser-chat-shell">
      <header className="browser-console-header">
        <div className="browser-brand"><img className="brand-icon" src="/qwanto-icon.png" alt="Qwanto" /><div><strong>Qwanto</strong><span>Local chat</span></div></div>
      ...
      <main className="browser-chat-main">
        <section className="browser-chat-card">
          {!props.connected && <div className="browser-local-note"><strong>Browser console</strong><span>This page is a safe local chat client. It cannot read projects, edit files, run commands, or use desktop agent tools. Open Qwanto Desktop to start the local gateway automatically.</span></div>}
