# warmup.ps1 - overnight expert-cache warmup for qwanto
#
# Runs `qwanto run` in a loop with diverse prompts so the engine records which
...
"qwanto warmup - started $start"        | Tee-Object -FilePath $Log -Append
...
"$line"                                           | Tee-Object -FilePath $Log -Append
"qwanto warmup - finished $end"                  | Tee-Object -FilePath $Log -Append
