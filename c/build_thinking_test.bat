...
set "OUT=D:\EcoUni\qwanto\c\test_thinking.exe"

clang -O3 -march=x86-64-v3 -fopenmp ^
    -I"%MSVC_INC%" -I"%SDK_INC%" -I"%SDK_INC_UM%" -I"%SRC%" ^
    "%SRC%\tests\test_thinking.c" "%SRC%\qwanto_thinking.c" "%SRC%\qwanto_decode.c" "%SRC%\qwanto_turboquant.c" "%SRC%\qwanto_kernels.c" "%SRC%\qwanto_native.c" "%SRC%\qwn_paged_kv.c" ^
