...
class ResourcePlanTest(unittest.TestCase):
    ...
    def test_applies_plan_without_overriding_explicit_settings(self):
        ...
        self.assertEqual(env["QWANTO_CUDA"], "1")
        self.assertEqual(env["QWANTO_GPUS"], "1")
    ...
    def test_cpu_binary_does_not_apply_gpu_tier(self):
        ...
        self.assertNotIn("QWANTO_CUDA", env)
        disabled = environment_for_plan(plan, {"QWANTO_CUDA": "0"}, cuda_enabled=True)
        self.assertNotIn("QWANTO_GPU", disabled)
    ...
    def test_balanced_policy_enables_lossless_live_repin(self):
        ...
        self.assertEqual(env["QWANTO_POLICY"], "balanced")
