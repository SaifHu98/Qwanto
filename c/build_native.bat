...
cl.exe /nologo /O2 /Oi /Ot /openmp /arch:AVX2 /fp:fast ^
  ...
  c/qwnrun.c c/qwanto_decode.c c/qwanto_native.c c/qwanto_kernels.c c/qwanto_turboquant.c c/qwanto_thinking.c c/qwanto_speculative.c c/qwn_paged_kv.c c/backend_loader.c ^
