...
clang -O3 -march=x86-64-v3 -mavxvnni -fopenmp ^
    ...
    "%SRC%\qwnrun.c" "%SRC%\qwanto_decode.c" "%SRC%\qwanto_native.c" "%SRC%\qwanto_kernels.c" "%SRC%\qwanto_turboquant.c" "%SRC%\qwanto_thinking.c" "%SRC%\qwanto_speculative.c" "%SRC%\qwanto_agentic.c" "%SRC%\qwanto_autopilot.c" "%SRC%\qwanto_gpu.c" "%SRC%\qwanto_bitdecoding.c" "%SRC%\qwn_paged_kv.c" ^
