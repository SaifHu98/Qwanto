...
import * as qwantoHandler from "./handlers/qwanto.handler";
...
function createWindow(): void {
  const windowOptions: Electron.BrowserWindowConstructorOptions = {
    width: 1280,
    height: 840,
    title: "Qwanto Native — Hardware-Saturated Coding Agent",
    webPreferences: {
  ...
  if (glassEnabled) {
    ...
    windowOptions.trafficLightPosition = { x: 16, y: 16 };
    windowOptions.backgroundColor = "#060911";
  }
...
mcpHandler.register();
qwantoHandler.register(getMainWindow);
